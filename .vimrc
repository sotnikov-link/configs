...
" Interface
    ...
    set guioptions+=c
    " Отключаем графические вкладки (текстовые занимают меньше места)
    set guioptions-=e
    " Отключить ToolBar
    set guioptions-=T
    " Number of colors
...
" Меню #start
    ...
    " Горячие клавиши скрытия/отображения меню #start
    ...
    " Горячие клавиши скрытия/отображения меню #end
" Меню #end
...
" Wildmenu
    set wildmenu " extended autocmpletion for commands
    set wildcharm=<TAB> " autocmpletion hotkey

" Курсор перемещается между строками: «конец строки — начало строки»
...
" Environment
    ...
    " Для сохранения позиции курсора
        augroup resCur
        autocmd!
