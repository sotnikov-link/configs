...
> todo: убрать уровень, подуровни вынести выше

1. [Изменение веб-браузера и почтового приложения по умолчанию](https://support.apple.com/HT201607)
...
Популярные менеджеры окон

- [Rectangle](https://rectangleapp.com/) с открытым исходным кодом 🔥
...
#### Разные расширения для разных проектов

> todo: написать про оптимизацию
