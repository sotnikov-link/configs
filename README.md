...
Делюсь своими настройками для macOS, VS Code и прочим, чтобы быстрее настраивать
новые компьютеры. Некоторые вещи можно адаптировать под Linux, Windows.
...
### Внешний монитор: управление яркостью и звуком
...
- [Teleport](https://github.com/johndbritton/teleport) — лучший KVM
  для macOS-устройств: на трекпаде работают жесты, плавная прокрутка страниц,
  курсор без тормозов.
